...
export function generateModeIntro(modeId: string, userProfile?: UserProfile | null): string {
  ...
  switch (canonicalModeId) {
    ...
    case MODE_IDS.MEME_GENERATOR:
      return preferredName
        ? `${preferredName}, envoie une image et je te propose des captions qui font rire en une seconde.`
        : 'Envoie une image et je te propose des captions qui font rire en une seconde.';
