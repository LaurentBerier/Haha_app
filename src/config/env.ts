...
export const STRIPE_CHECKOUT_URL_REGULAR = EXPO_PUBLIC_STRIPE_CHECKOUT_URL_REGULAR ?? EXPO_PUBLIC_STRIPE_CHECKOUT_URL ?? '';
export const STRIPE_CHECKOUT_URL_PREMIUM = EXPO_PUBLIC_STRIPE_CHECKOUT_URL_PREMIUM ?? '';
