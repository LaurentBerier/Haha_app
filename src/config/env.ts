...
const EXPO_PUBLIC_SENTRY_ENVIRONMENT = process.env.EXPO_PUBLIC_SENTRY_ENVIRONMENT;
const EXPO_PUBLIC_SENTRY_RELEASE = process.env.EXPO_PUBLIC_SENTRY_RELEASE;
const EXPO_PUBLIC_SENTRY_TRACES_SAMPLE_RATE = process.env.EXPO_PUBLIC_SENTRY_TRACES_SAMPLE_RATE;
...
export const SENTRY_ENVIRONMENT = EXPO_PUBLIC_SENTRY_ENVIRONMENT ?? '';
export const SENTRY_RELEASE = EXPO_PUBLIC_SENTRY_RELEASE ?? '';
export const SENTRY_TRACES_SAMPLE_RATE = EXPO_PUBLIC_SENTRY_TRACES_SAMPLE_RATE ?? '';
